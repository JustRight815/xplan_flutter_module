...
class VideoBean extends Object {
  ...
  VideoBean(this.itemList,this.count,this.total,this.nextPageUrl,this.adExist,);

  factory VideoBean.fromJson(Map<String, dynamic> srcJson) => _$VideoBeanFromJson(srcJson);
